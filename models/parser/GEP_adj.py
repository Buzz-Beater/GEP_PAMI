...
class GeneralizedEarley(object):
    def __init__(self, grammar, prior_flag=False, mapping=None):
    ...
    def _parse_init(self, classifier_output=None):
        ...
        for r in self._grammar.productions():
            if str(r.lhs()) == 'GAMMA':
                ...
                break
        heapq.heappush(self._queue, ((-np.inf, (0, 0, '', self._state_set[0][0]))))
        ...
        while self._queue:
            ...
            for new_m, new_n, new_prefix_str in new_scanned_states:
                ...
                if not new_prefix_str in self._cached_grammar_prob.keys():
                    ...
                    for new_s in self._state_set[new_m][new_n]:
                        new_s.prob = prob
                    heapq.heappush(self._queue, (-prob, (new_m, new_n, new_prefix_str, self._state_set[new_m][new_n])))
    ...
    def compute_prob(self, prefix):
        ...
        if l not in self._cached_log_prob:
            ...
            if self._total_frame == 1:
                ...
                # print(self._cached_log_prob[l_minus][0:self._total_frame - 1])
        ...
        # print(prefix, self._cached_log_prob[l][self._total_frame], self._total_frame)
